...
const NewListingsStats = ({ isInView, totalNewTokens, totalLiquidity, totalVolume, averageReturn }) => {
  // Animation variants
  ...
  const stats = [
    ...
    },
    {
      ...
      color: averageReturn >= 0 ? 'from-green-600 to-green-400' : 'from-red-600 to-red-400',
      textColor: averageReturn >= 0 ? 'text-green-400' : 'text-red-400'
    }
  ];
...
export default NewListingsStats;